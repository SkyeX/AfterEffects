This will randomly select a color from a layer's Effects.

1. Create a layer named Colors with only your Color Effects on it. The first color will be your default.
2. Add the randomColorFromEffectsControls preset to the layer whose color property you are effecting.
